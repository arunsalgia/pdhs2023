...
return (
	...
	{(stage === "INITIAL") &&
		<div>
		<br />
		<Typography align="left" style={{paddingTop: "5px" }} className={gClasses.patientInfo2Blue} >{`Husband: Salgia Ankit Arun`}</Typography>
		<Typography align="left" style={{paddingTop: "5px" }} className={gClasses.patientInfo2Blue} >{`Wife:   Salgia Krati Ankit`}</Typography>
	...
	<br />
	{(("Pending" === APPLICATIONSTATUS.pending) && (stage === "INITIAL")) &&
	...
	<div align="center">
		...
		<textarea
			...
			readOnly = {("Pending" !== "Pending")}   // Specifies that the text area is read-only, meaning the user cannot modify its content
