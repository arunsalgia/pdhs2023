...
async function handleSubmitMobile(e) {
  ...
  <Grid  key="LandingPage" container align="center">
      ...
      <Typography className={gClasses.title}>Pratapgarh Rajasthan Welfare Samaj</Typography>
      <br />
      <br />
      <VsButton label="Get Started" onClick={handleGetStarted} />
    </Grid>
		<Grid item xs={6} sm={6} md={6} lg={6} >	
      <img src="%PUBLIC_URL%/image/LANDINGPAGE.JPG" />
    </Grid>
  </Grid>
	</div>
  );
